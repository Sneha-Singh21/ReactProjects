...
const FeatureCard = ({ icon, title, content, index }) => (
  <div className={`flex flex-row p-6 rounded-[20px] md:mr-3 ${index !== features.length - 1 ? "mb-5" : "mb-0"} feature-card`}>
  ...
  <section id='features' className={layout.section}>
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-3`}>
        ...
        credit, earning reward and saving money. But with hundreds of credit cards on the market.
      </p>
